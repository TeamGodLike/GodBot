...
require('./hancock.js')
nocache('../hancock.js', module => console.log(color('[ CHANGE ]', 'green'), color(`'${module}'`, 'green'), 'Updated'))
require('./main.js')
...
try{
		...
		if (update.connection == "open" || update.receivedPendingNotifications == "true") {
	        ...
	        console.log(color(`\n${themeemoji} YT CHANNEL: senzhndra`,'magenta'))
            console.log(color(`${themeemoji} GITHUB: CandyMD `,'magenta'))
            console.log(color(`${themeemoji} INSTAGRAM: @senzhndra `,'magenta'))
...
"sourceUrl": `${wagc}`}}})
                    ...
                    xeonbody = `❖━━━━━━━━[ ʟᴇᴀᴠɪɴɢ ]━━━━━━━━❖\n𝚂𝚊𝚢𝚘𝚗𝚊𝚛𝚊𝚊 @${xeonName.split("@")[0]} 👋\n\n_Setiap pertemuan pasti ada perpisahan🥀_\n_Semoga perpisahan ini hanya sementara, dan kita dapat bertemu kembali di masa depan. Tetaplah dalam ingatanku, dan semoga kebahagiaan selalu menyertaimu. Sampai jumpa lagi, Member Suki. Selamat jalan._\n\n📮 *Pesan:* Jika menemukan bug, error, atau kesulitan dalam penggunaan, silakan laporkan/tanyakan kepada owner👑`
XeonBotInc.sendMessage(anu.id,
 { text: xeonbody,
 contextInfo:{
 mentionedJid:[num],
 "externalAdReply": {"showAdAttribution": true,
 "title": `𝙨 𝙖 𝙮 𝙤 𝙣 𝙖 𝙧 𝙖 ~👋`,
"body": `${ownername}`,
"renderLargerThumbnail": true,
"mediaType": 1,
"thumbnailUrl": XeonLft,
"thumbnail": XeonLft,
"sourceUrl": `${wagc}`}}})
}
}
...
ppgroup = 'https://i.ibb.co/RBx5SQC/avatar-group-large-v2.png?q=60'
    ...
    XeonBotInc.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./hancock")(XeonBotInc, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
